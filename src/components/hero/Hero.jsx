        ...
        <div className='bg-blue-100 pt-[100px] pb-[300px]'>
            <div className='container mx-auto px-5'>
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="">
                        <h1 className="text-blue-500 lg:w-full leading-10 md:leading-[60px] lg:leading-[68px] text-center lg:text-start text-[31px] md:text-5xl lg:text-[56px] font-bold">Read the most interesting articles</h1>
